...
const Checkout = () => {
  ...
  const submitHandler = (event) => {
    ...
    const enteredLastNameIsValid = !isEmpty(order.lastName);
    const enteredCountryIsValid = !isEmpty(order.country);
    const enteredStreetIsValid = isFiveChars(order.street);
    const enteredPostalCodeIsValid = !isEmpty(order.postalCode);
    const enteredCityIsValid = !isEmpty(order.city);
    const enteredPhoneIsValid = !isEmpty(order.phone);
    const enteredEmailIsValid =
      !isEmpty(order.email) && verifyEmail(order.email);
    ...
    <div>
      ...
      <form className={classes.grid} onSubmit={submitHandler}>
        <div className={classes.main}>
          ...
          <div className={classes['form-display']}>
            <div>
            ...
            {!formInputsValidity.firstName && (
              <p className={classes.comment}>Please enter a valid name!</p>
            )}
          </div>
          <div className={classes['form-display']}>
            <div>
          ...
          <div className={classes['form-display']}>
            ...
            {!formInputsValidity.street && (
              <p className={classes.comment}>Please enter a valid street!</p>
            )}
          </div>
          <div className={classes['form-display']}>
            <div>
          ...
          <div className={classes['form-display']}>
            ...
            {!formInputsValidity.city && (
              <p className={classes.comment}>Please enter a valid city!</p>
            )}
          </div>
          <div className={classes['form-display']}>
            <div>
            ...
            {!formInputsValidity.phone && (
              <p className={classes.comment}>Please enter a valid phone!</p>
            )}
          </div>
          <div className={classes['form-display']}>
            <div>
            ...
            {!formInputsValidity.email && (
              <p className={classes.comment}>Please enter a valid email!</p>
            )}
          </div>
        </div>
